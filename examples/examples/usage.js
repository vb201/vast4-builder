...
const complexLinearAd = (0, src_1.buildInlineAd)({
    id: 'pre-roll-001',
    ...
    creatives: [{
            linear: {
                ...
                skipoffset: '00:00:05',
                tracking: [
                    ...(0, src_1.withIABQuartiles)('https://analytics.example.com/tracking'),
                    ...
                    { event: 'progress', offset: '00:00:10', url: 'https://analytics.example.com/10s' },
                    { event: 'progress', offset: '50%', url: 'https://analytics.example.com/50pct' }
                ],
                clicks: {
...
const xml1 = (0, src_1.buildVast)({ ads: [complexLinearAd] });
console.log(xml1);
console.log('\n');
// Example 2: Ad Pod (Sequential Ads)
console.log('=== Example 2: Ad Pod ===');
const ad1 = (0, src_1.buildInlineAd)({
    title: 'Pod Ad 1',
    impressions: ['https://analytics.example.com/pod/ad1/impression'],
    creatives: [{
            linear: {
                duration: (0, src_1.toClockTime)(15), // 15 seconds
                tracking: (0, src_1.withIABQuartiles)('https://analytics.example.com/pod/ad1'),
                mediaFiles: [{
...
const ad2 = (0, src_1.buildInlineAd)({
    title: 'Pod Ad 2',
    impressions: ['https://analytics.example.com/pod/ad2/impression'],
    creatives: [{
            linear: {
                duration: (0, src_1.toClockTime)(30), // 30 seconds
                tracking: (0, src_1.withIABQuartiles)('https://analytics.example.com/pod/ad2'),
                mediaFiles: [{
...
const pod = (0, src_1.buildAdPod)([ad1, ad2]);
const xml2 = (0, src_1.buildVast)({ ads: pod });
console.log(xml2);
console.log('\n');
// Example 3: Wrapper Ad (Ad Network Chain)
console.log('=== Example 3: Wrapper Ad ===');
const wrapperAd = (0, src_1.buildWrapperAd)({
    id: 'wrapper-001',
...
const xml3 = (0, src_1.buildVast)({ ads: [wrapperAd] });
console.log(xml3);
console.log('\n');
// Example 4: Non-Linear Overlay
console.log('=== Example 4: Non-Linear Overlay ===');
const overlayAd = (0, src_1.buildInlineAd)({
...
const xml5 = (0, src_1.buildVast)({ ads: [mixedAd] });
console.log(xml5);
console.log('\n');
